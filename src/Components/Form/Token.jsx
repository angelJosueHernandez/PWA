        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="social-icons">
            <a href="#" className="icon">
              <i className="fa-brands fa-Whatsapp-f">
                <SiWhatsapp />
              </i>
            </a>
            <a href="#" className="icon">
              <i className="fa-brands fa-sms">
                <FcSms />
              </i>
            </a>
          </div>
          ...
          <div className="sm:col-span-6">
            ...
            <div className="mt-1">
              <input
                ...
                type="text"
                className="  {emailError ? 'input-error' : ''} block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
            </div>
          ...
          <div className="cont-remen2">
            <Link to={'/Recuperacion'}>Regresar</Link>
          </div>
        </form>
      </div>
    </div>
