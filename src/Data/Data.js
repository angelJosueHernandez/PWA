...
export const lettestArticleData = [
  {
    id: 1,
    title:
      'Accidente de motocicleta en la calle principal. El conductor fue atendido por paramédicos y trasladado al hospital.',
    image: ArticleImage1,
    titLink: '#',
    date: '2 ago, 2024',
  ...
  },
  {
    ...
    image: ArticleImage2,
    title:
      'Equipo de emergencia atiende a paciente sospechoso de COVID-19. Se tomaron todas las medidas de seguridad.',
    titleLink: '*',
    date: '2 ago, 2024',
    inspiration: 'Últimas Noticias',
    fbLink: '*',
  ...
  },
  {
    ...
    image: ArticleImage3,
    title:
      'Atención a persona lesionada en la vía pública. Los paramédicos brindaron primeros auxilios en el lugar.',
    titleLink: '*',
    date: '2 ago, 2024',
    inspiration: 'Últimas Noticias',
    fbLink: '*',
...
export const serviciosCruzRoja = [
  {
    ...
    descripcion:
      'Equipo especializado en rescate en entornos urbanos y estructuras colapsadas.',
  },
  {
    id: 2,
    ...
    descripcion:
      'Unidad móvil dedicada a brindar atención médica a niños y adolescentes en comunidades rurales.',
  },
  {
    id: 3,
    ...
    descripcion:
      'Servicio que ofrece apoyo emocional y psicológico a personas afectadas por desastres o crisis.',
  },

  {
    ...
    descripcion:
      'Instalación dedicada a la recolección de sangre para emergencias médicas y transfusiones.',
  },
  {
    id: 5,
    ...
    descripcion:
      'Equipo especializado en la gestión eficiente de recursos y suministros durante situaciones de emergencia.',
  },
  {
    id: 6,
    ...
    descripcion:
      'Facilidad dedicada a la rehabilitación y fisioterapia para personas con discapacidades físicas temporales o permanentes.',
  },
  {
    id: 7,
    ...
    descripcion:
      'Unidad canina entrenada para la búsqueda y rescate de personas en áreas afectadas por desastres naturales.',
  },
  {
    id: 8,
    ...
    descripcion:
      'Programa educativo que proporciona información sobre salud, prevención de enfermedades y primeros auxilios a comunidades locales.',
  },
  {
    id: 9,
    ...
    descripcion:
      'Grupo especializado en proporcionar apoyo inmediato y recursos durante crisis humanitarias para mitigar el impacto emocional en las personas afectadas.',
  },
  {
    id: 10,
    ...
    descripcion:
      'Servicio que ofrece consultas médicas a distancia, brindando atención a comunidades remotas a través de tecnología de telemedicina.',
  },
  {
    id: 11,
    ...
    descripcion:
      'Equipo encargado de la distribución eficiente de suministros esenciales durante desastres y emergencias, garantizando una respuesta rápida y efectiva.',
  },
  {
    id: 12,
    ...
    descripcion:
      'Facilidad dedicada a la atención y recuperación de niños con desnutrición, proporcionando alimentos nutritivos y cuidado médico especializado.',
  },
  {
    id: 13,
    ...
    descripcion:
      'Grupo especializado en recopilar, analizar y gestionar información relevante durante crisis humanitarias para facilitar una toma de decisiones informada.',
  },
  {
    id: 14,
    ...
    descripcion:
      'Instalación que ofrece cursos y capacitación en primeros auxilios a la comunidad, promoviendo la preparación y la respuesta rápida ante emergencias.',
  },
];
