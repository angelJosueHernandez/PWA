...
export default function Donaciones() {
  ...
  const validateTelefono = (telefono) => {
    ...
    if (telefono === '') {
      ...
      setTelefonoError(
        'El número de teléfono debe tener  10 digitos, no se aceptan letras',
      );
      return false;
    } else {
      setTelefonoError('');
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          <div className="sm:max-w-lg">
            ...
            <p className="mt-4 text-[15px] text-gray-500">
              Tu generosidad puede salvar vidas. Únete a nuestra misión y ayuda
            ...
            <form className="space-y-3 max-w-lg mx-auto sm:ml-[-5px] formDona">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  />
                  {nombreError && (
                    <p className="mt-1 text-xs error-message ">{nombreError}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {apellidoPError && (
                    <p className="mt-1 text-xs error-message">
                      {apellidoPError}
                    </p>
                  )}
                </div>
              ...
              <div>
                ...
                />
                {emailError && (
                  <p className="mt-1 text-xs error-message">{emailError}</p>
                )}
              </div>
